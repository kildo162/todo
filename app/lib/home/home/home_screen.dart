...
import 'package:app/home/health/health_screen.dart';
...
import 'package:app/sutra/sutra_screen.dart';
          ...
          children: [
            ...
            Row(
              children: [
                ...
                const Spacer(),
                TextButton(
                  onPressed: () => Get.to(() => QuickActionManagementScreen()),
            ...
            Obx(() {
              ...
              if (actions.isEmpty) {
                return Container(
                  ...
                  child: Text(
                    'Tất cả lối tắt đã tắt. Nhấn "Quản lý" để bật lại.',
              ...
              for (
                int i = 0;
                i < actions.length && rows.length < 2;
                i += itemsPerRow
              ) {
                final slice = actions.skip(i).take(itemsPerRow).toList();
                rows.add(
                  Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    _svg(
                                      'assets/icons/outline/clock.svg',
                                      size: 14,
                                    ...
                                    _svg(
                                      'assets/icons/outline/map-pin.svg',
                                      size: 14,
                                      color: Colors.grey.shade600,
                                    ),
                                    const SizedBox(width: 4),
